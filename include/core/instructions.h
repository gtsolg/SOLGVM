...
__VM_STD_INSTR_PROTO(je8_imm);
__VM_STD_INSTR_PROTO(je8_rptr);
__VM_STD_INSTR_PROTO(je8_iptr);
__VM_STD_INSTR_PROTO(je16_reg);
__VM_STD_INSTR_PROTO(je16_imm);
__VM_STD_INSTR_PROTO(je16_rptr);
__VM_STD_INSTR_PROTO(je16_iptr);
__VM_STD_INSTR_PROTO(je32_reg);
__VM_STD_INSTR_PROTO(je32_imm);
__VM_STD_INSTR_PROTO(je32_rptr);
__VM_STD_INSTR_PROTO(je32_iptr);
__VM_STD_INSTR_PROTO(je64_reg);
__VM_STD_INSTR_PROTO(je64_imm);
__VM_STD_INSTR_PROTO(je64_rptr);
__VM_STD_INSTR_PROTO(je64_iptr);
...
__VM_STD_INSTR_PROTO(jg8_reg);
__VM_STD_INSTR_PROTO(jg8_imm);
__VM_STD_INSTR_PROTO(jg8_rptr);
__VM_STD_INSTR_PROTO(jg8_iptr);
__VM_STD_INSTR_PROTO(jg16_reg);
__VM_STD_INSTR_PROTO(jg16_imm);
__VM_STD_INSTR_PROTO(jg16_rptr);
__VM_STD_INSTR_PROTO(jg16_iptr);
__VM_STD_INSTR_PROTO(jg32_reg);
__VM_STD_INSTR_PROTO(jg32_imm);
__VM_STD_INSTR_PROTO(jg32_rptr);
__VM_STD_INSTR_PROTO(jg32_iptr);
__VM_STD_INSTR_PROTO(jg64_reg);
__VM_STD_INSTR_PROTO(jg64_imm);
__VM_STD_INSTR_PROTO(jg64_rptr);
__VM_STD_INSTR_PROTO(jg64_iptr);



__VM_STD_INSTR_PROTO(jge8_reg);
__VM_STD_INSTR_PROTO(jge8_imm);
__VM_STD_INSTR_PROTO(jge8_rptr);
__VM_STD_INSTR_PROTO(jge8_iptr);
__VM_STD_INSTR_PROTO(jge16_reg);
__VM_STD_INSTR_PROTO(jge16_imm);
__VM_STD_INSTR_PROTO(jge16_rptr);
__VM_STD_INSTR_PROTO(jge16_iptr);
__VM_STD_INSTR_PROTO(jge32_reg);
__VM_STD_INSTR_PROTO(jge32_imm);
__VM_STD_INSTR_PROTO(jge32_rptr);
__VM_STD_INSTR_PROTO(jge32_iptr);
__VM_STD_INSTR_PROTO(jge64_reg);
__VM_STD_INSTR_PROTO(jge64_imm);
__VM_STD_INSTR_PROTO(jge64_rptr);
__VM_STD_INSTR_PROTO(jge64_iptr);



__VM_STD_INSTR_PROTO(jl8_reg);
__VM_STD_INSTR_PROTO(jl8_imm);
__VM_STD_INSTR_PROTO(jl8_rptr);
__VM_STD_INSTR_PROTO(jl8_iptr);
__VM_STD_INSTR_PROTO(jl16_reg);
__VM_STD_INSTR_PROTO(jl16_imm);
__VM_STD_INSTR_PROTO(jl16_rptr);
__VM_STD_INSTR_PROTO(jl16_iptr);
__VM_STD_INSTR_PROTO(jl32_reg);
__VM_STD_INSTR_PROTO(jl32_imm);
__VM_STD_INSTR_PROTO(jl32_rptr);
__VM_STD_INSTR_PROTO(jl32_iptr);
__VM_STD_INSTR_PROTO(jl64_reg);
__VM_STD_INSTR_PROTO(jl64_imm);
__VM_STD_INSTR_PROTO(jl64_rptr);
__VM_STD_INSTR_PROTO(jl64_iptr);



__VM_STD_INSTR_PROTO(jle8_reg);
__VM_STD_INSTR_PROTO(jle8_imm);
__VM_STD_INSTR_PROTO(jle8_rptr);
__VM_STD_INSTR_PROTO(jle8_iptr);
__VM_STD_INSTR_PROTO(jle16_reg);
__VM_STD_INSTR_PROTO(jle16_imm);
__VM_STD_INSTR_PROTO(jle16_rptr);
__VM_STD_INSTR_PROTO(jle16_iptr);
__VM_STD_INSTR_PROTO(jle32_reg);
__VM_STD_INSTR_PROTO(jle32_imm);
__VM_STD_INSTR_PROTO(jle32_rptr);
__VM_STD_INSTR_PROTO(jle32_iptr);
__VM_STD_INSTR_PROTO(jle64_reg);
__VM_STD_INSTR_PROTO(jle64_imm);
__VM_STD_INSTR_PROTO(jle64_rptr);
__VM_STD_INSTR_PROTO(jle64_iptr);
